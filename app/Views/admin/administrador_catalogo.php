...
<div class="container mt-4">
  <h1 class="mb-4 text-white text-center"><?= esc($title) ?></h1>
      ...
      <form method="get" action="<?= site_url('admin/catalogo') ?>" class="row g-3">
        <div class="col-12">
        ...
        <div class="col-12">
          ...
          <input type="number" step="0.01" name="precio_min" class="form-control" value="<?= esc($filtros['precio_min']) ?>">
        </div>

        <div class="col-12">
          <label class="form-label text-white">Precio hasta</label>
          <input type="number" step="0.01" name="precio_max" class="form-control" value="<?= esc($filtros['precio_max']) ?>">
        </div>
