                        ...
                        <div class="table-responsive">
                            <table class="table align-middle mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td style="width: 80px;">
                                            <img src="/proyecto_taller/assets/img/<?= esc(basename($p['imagen'])) ?>" alt="imagen" class="img-thumbnail" style="max-width: 70px;">
                                        </td>
                                        <td>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card shadow" style="min-height: 100%;">
                    ...
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="/proyecto_taller/public/pedidos/finalizar-compra" method="post">
                            <?= csrf_field() ?>
                            <div class="mb-3">
